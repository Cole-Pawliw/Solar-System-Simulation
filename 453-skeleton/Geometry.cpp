...
void GPU_Geometry::setTexture(const std::vector<glm::vec2>& texture) {
	textureBuffer.uploadData(sizeof(glm::vec2) * texture.size(), texture.data(), GL_STATIC_DRAW);
}
